...
public class MovieServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -4926061364356935862L;
	...
	private static void writeJSON(HttpServletResponse response, MovieList movies) throws IOException {
